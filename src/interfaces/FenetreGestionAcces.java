...
public class FenetreGestionAcces extends JFrame implements ListSelectionListener{
    ...
    private final TypeAccesDAO typeAccesDAO;
    private Lieu lieu;
    ...
    public FenetreGestionAcces(Lieu lieu){
        ...
        for(int i = 0 ; i<lieu.getListeAcces().size() ; i++ ){
            listeModele.addElement( typeAccesDAO.nomTypeAcces( lieu.getListeAcces().get(i) ) );
        }
        ...
        for (String aNomType : typeAccesDAO.recupereToutlesTypes()) {
    ...
    class EcouteBoutonAjouter implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            lieu.ajoutAcces(typeAccesDAO.getID(nomAjout));
